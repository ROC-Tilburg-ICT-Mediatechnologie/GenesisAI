...
const uploader = require("./server/multer.js");
...
cloudinary.config({
  cloud_name: "dtdwe1a8t",
  api_key: "433287432123578",
  api_secret: "qpE_m_zi32YM-GewtGgfq7LNbhc"
});
  ...
  if (prompt) {
    ...
    const options = {
      ...
      headers: {
        ...
        "X-RapidAPI-Key": "9e5ce3ec00msha893101f89999edp14d002jsna655f133d308",
...
app.post("/upload", upload.single("file"), async (req, res) => {
  if (req.file) {
    ...
    console.log(`Bestand geüpload: ${upload.secure_url}`); // Logt de bestandsnaam
